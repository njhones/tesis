...
namespace Growth_Polygon
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		/*	L_Point Pt;
			...
			Pt= new L_Point(100,100);
			line.Add(Pt);
			Pt= new L_Point(150,100);
			line.Add(Pt);
			Pt= new L_Point(154,150);
			line.Add(Pt);
			Pt= new L_Point(162,50);
			line.Add(Pt);
			Pt= new L_Point(166,100);
			line.Add(Pt);
			Pt= new L_Point(200,100);
			line.Add(Pt);
			Pt= new L_Point(200,200);
			line.Add(Pt);
			Pt= new L_Point(100,200);
			...
			Pt= new L_Point(150,300);
			line.Add(Pt);
			Pt= new L_Point(135,350);
			line.Add(Pt);
			Pt= new L_Point(105,250);
			line.Add(Pt);
			#endregion
		...
		private void btnParallel_Click(object sender, System.EventArgs e)
		{
				...
				( ((L_Point)line[0]).y == ((L_Point)line[line.Count-1]).y ) )
			{
				...
				for( i =0; i< List.Count; i++ )
				{
					...
					{
						parallel[i].Add( new L_Point( ((IntervalNode.VertexOfRegion)((ArrayList)List[i])[j]).Pt ) );
					}
