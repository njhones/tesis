...
\begin{figure}[htbp]
\begin{center}
\includegraphics{conjuntop.jpg}%[width=7cm, height=5cm]
\end{center}
...
Geom\'etricamente el resultado de hacer crecer o decrecer un pol\'igono $P$ mediante paralelas a una distancia $d$ puede ser visto al intentar dibujar $P$ con una pluma de grosor $d$. %Ver Figura 1.2. 

\begin{figure}[h]
\begin{center}
\includegraphics{plumad.jpg}%[width=15cm]htbp
\end{center}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics{tonyzad.jpg}%[width=15cm]
\end{center}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics{picop.jpg}%[width=15cm]
\end{center}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics{parcialt.jpg}%[width=15cm]
\end{center}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics{arbolp.jpg}%[width=15cm]
\end{center}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics{carap.jpg}%[width=15cm]
\end{center}
